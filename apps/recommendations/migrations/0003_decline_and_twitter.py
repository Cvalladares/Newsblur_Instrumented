...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RecommendedFeed.declined_date'
        db.add_column('recommendations_recommendedfeed', 'declined_date', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)

        # Adding field 'RecommendedFeed.twitter'
        db.add_column('recommendations_recommendedfeed', 'twitter', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RecommendedFeed.declined_date'
        db.delete_column('recommendations_recommendedfeed', 'declined_date')

        # Deleting field 'RecommendedFeed.twitter'
        db.delete_column('recommendations_recommendedfeed', 'twitter')
    ...
    models = {
        ...
        'recommendations.recommendedfeed': {
            'Meta': {'ordering': "['-approved_date']", 'object_name': 'RecommendedFeed'},
            ...
            'declined_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
