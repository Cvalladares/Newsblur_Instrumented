...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OAuthToken.uuid'
        db.add_column('feed_import_oauthtoken', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OAuthToken.uuid'
        db.delete_column('feed_import_oauthtoken', 'uuid')
    ...
    models = {
        ...
        'feed_import.oauthtoken': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'})
        }
    }
