...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.collapsed_folders'
        db.add_column('profile_profile', 'collapsed_folders', self.gf('django.db.models.fields.TextField')(default='[]'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.collapsed_folders'
        db.delete_column('profile_profile', 'collapsed_folders')
