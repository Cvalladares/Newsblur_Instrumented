...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.timezone'
        db.add_column('profile_profile', 'timezone', self.gf('utils.timezones.fields.TimeZoneField')(default='America/New_York', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.timezone'
        db.delete_column('profile_profile', 'timezone')
