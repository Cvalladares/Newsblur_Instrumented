...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.is_premium'
        db.add_column('profile_profile', 'is_premium', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.is_premium'
        db.delete_column('profile_profile', 'is_premium')
