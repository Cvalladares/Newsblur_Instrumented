...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.secret_token'
        db.add_column('profile_profile', 'secret_token', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.secret_token'
        db.delete_column('profile_profile', 'secret_token')
