...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Feed', fields ['feed_address']
        db.create_index('feeds', ['feed_address'])


    def backwards(self, orm):
        
        # Removing index on 'Feed', fields ['feed_address']
        db.delete_index('feeds', ['feed_address'])
