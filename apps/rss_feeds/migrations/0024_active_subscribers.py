...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feed.active_subscribers'
        db.add_column('feeds', 'active_subscribers', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feed.active_subscribers'
        db.delete_column('feeds', 'active_subscribers')
