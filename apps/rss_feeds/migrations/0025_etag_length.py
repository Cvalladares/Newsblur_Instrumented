...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('feeds', 'etag', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'Feed.etag'
        db.alter_column('feeds', 'etag', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
