...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing index on 'Feed', fields ['next_scheduled_update']
        db.delete_index('feeds', ['next_scheduled_update'])
    ...
    def backwards(self, orm):
        ...
        # Adding index on 'Feed', fields ['next_scheduled_update']
        db.create_index('feeds', ['next_scheduled_update'])
