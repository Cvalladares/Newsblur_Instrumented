...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Feed.last_update'
        db.alter_column('feeds', 'last_update', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'Feed.last_update'
        db.alter_column('feeds', 'last_update', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
