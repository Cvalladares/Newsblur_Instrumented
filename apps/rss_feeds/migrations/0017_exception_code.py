...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feed.exception_code'
        db.add_column('feeds', 'exception_code', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feed.exception_code'
        db.delete_column('feeds', 'exception_code')
