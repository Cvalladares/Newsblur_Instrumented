...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeedLoadtime.date_accessed'
        db.alter_column('rss_feeds_feedloadtime', 'date_accessed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'FeedUpdateHistory.fetch_date'
        db.alter_column('rss_feeds_feedupdatehistory', 'fetch_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'FeedFetchHistory.fetch_date'
        db.alter_column('rss_feeds_feedfetchhistory', 'fetch_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'PageFetchHistory.fetch_date'
        db.alter_column('rss_feeds_pagefetchhistory', 'fetch_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))


    def backwards(self, orm):
        
        # Changing field 'FeedLoadtime.date_accessed'
        db.alter_column('rss_feeds_feedloadtime', 'date_accessed', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'FeedUpdateHistory.fetch_date'
        db.alter_column('rss_feeds_feedupdatehistory', 'fetch_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'FeedFetchHistory.fetch_date'
        db.alter_column('rss_feeds_feedfetchhistory', 'fetch_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'PageFetchHistory.fetch_date'
        db.alter_column('rss_feeds_pagefetchhistory', 'fetch_date', self.gf('django.db.models.fields.DateTimeField')())
