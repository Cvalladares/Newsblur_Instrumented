...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feed.feed_link_locked'
        db.add_column('feeds', 'feed_link_locked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feed.feed_link_locked'
        db.delete_column('feeds', 'feed_link_locked')
