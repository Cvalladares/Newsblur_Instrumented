...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rss_feeds_feedloadtime', (
            ...
            ('date_accessed', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
    ...
    models = {
        ...
        'rss_feeds.feedloadtime': {
            ...
            'date_accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
