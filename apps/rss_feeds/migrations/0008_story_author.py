...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Story.story_author_name'
        db.add_column('stories', 'story_author_name', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Story.story_author_name'
        db.delete_column('stories', 'story_author_name')
