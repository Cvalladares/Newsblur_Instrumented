...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DuplicateFeed.duplicate_feed_id'
        db.add_column('rss_feeds_duplicatefeed', 'duplicate_feed_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DuplicateFeed.duplicate_feed_id'
        db.delete_column('rss_feeds_duplicatefeed', 'duplicate_feed_id')
