...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserSubscription.active'
        db.add_column('reader_usersubscription', 'active', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserSubscription.active'
        db.delete_column('reader_usersubscription', 'active')
    ...
    models = {
        ...
        'reader.usersubscription': {
            ...
            'last_read_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 13, 23, 31, 39, 760707)'}),
            'mark_read_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 13, 23, 31, 39, 760707)'}),
